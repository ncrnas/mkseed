...
namespace {
    ...
    TEST_F(TestDS4, comp_ngram) {
        comp_ngram();
    }

    TEST_F(TestDS4, comp_bruteforce) {
        comp_bruteforce();
    }

    TEST_F(TestDS4, comp_horspool) {
        comp_horspool();
    }

    TEST_F(TestDS4, comp_suffixarray) {
        comp_suffixarray();
    }
}