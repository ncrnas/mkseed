...
namespace {
    ...
    class U3005 : public TestDS
    {
    protected:
        U3005() {
            IFNAME1 = (char *)"mir_001.txt";
            IFNAME2 = (char *)"utr3_005.txt";
    ...
    TEST_F(U3005, comp_ngram) {
        comp_ngram();
    }

    TEST_F(U3005, comp_bruteforce) {
        comp_bruteforce();
    }

    TEST_F(U3005, comp_horspool) {
        comp_horspool();
    }

    TEST_F(U3005, comp_suffixarray) {
        comp_suffixarray();
    }
}